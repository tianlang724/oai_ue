...
void *nas_ue_task(void *args_p)
{
  ...
  for (int i=0; i < users->count; i++)
  {
   ...
   printf("[nas_ue_task] zh usim_data_store=%s\n",user->usim_data_store);
   fflush(stdout);
    ...
    printf("[nas_ue_task]zh user_nvdata_store=%s\n",user->user_nvdata_store);
	fflush(stdout);
   ...
   printf("[nas_ue_task]zh emm_nvdata_store=%s\n",user->emm_nvdata_store);
   fflush(stdout);
